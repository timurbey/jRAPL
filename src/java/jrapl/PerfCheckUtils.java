...
public class PerfCheckUtils {
  public static native void perfInit(int numEvents, int isSet);

  public static native void singlePerfEventCheck(String eventNames);

  public static native void groupPerfEventsCheck(String eventNames);

  public static native void perfEnable();

  public static native void perfDisable();

  public static native void perfSingleRead(int id, long[] buffer);

  public static native void perfMultRead(long[] buffer);

  public static native long processSingleValue(long[] buffer);

  public static native long[] processMultiValue(long[] buffer);
